...
fn test_register_component() {
    ...
    component_manager.register(Component::new(component_name.clone(), vec![PropertyType::new(property_name.clone(), DataType::String)]));
...
fn test_export_import_component() {
    ...
    component_manager.create(component_name.as_str(), vec![PropertyType::new(String::from("x"), DataType::String)]);
