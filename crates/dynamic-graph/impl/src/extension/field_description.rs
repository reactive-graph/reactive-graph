use reactive_graph_dynamic_graph_model::EXTENSION_DYNAMIC_GRAPH_FIELD_DESCRIPTION;
...
pub fn get_dynamic_graph_field_descriptions(extension_container: &impl ExtensionContainer) -> DynamicGraphFieldDescriptionExtension {
    match extension_container.get_own_extension(&EXTENSION_DYNAMIC_GRAPH_FIELD_DESCRIPTION.clone()) {
