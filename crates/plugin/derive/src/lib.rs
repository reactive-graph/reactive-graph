...
//         quote! {
//             #[inexor_rgf_plugin_api::springtime_di::component_alias]
//         }
//     } else {
//         TokenStream2::new()
//     };
...
//     let json = {
//         quote! {
//             match inexor_rgf_plugin_api::serde_json::from_str(asset_str) {
//                 Ok(parsed_entry) => {
...
//     let json5 = {
//         quote! {
//             match inexor_rgf_plugin_api::json5::from_str(asset_str) {
//                 Ok(parsed_entry) => {
//                     let entry: <#tys as inexor_rgf_graph::NamespacedTypeContainer>::Type = parsed_entry;
//                     inexor_rgf_graph::NamespacedTypeContainer::push(&entries, entry);
//                 }
...
//     let toml = {
//         quote! {
//             match inexor_rgf_plugin_api::toml::from_str(asset_str) {
//                 Ok(parsed_entry) => {
//                     let entry: <#tys as inexor_rgf_graph::NamespacedTypeContainer>::Type = parsed_entry;
//                     inexor_rgf_graph::NamespacedTypeContainer::push(&entries, entry);
//                 }
...
//         #component_alias
//         impl inexor_rgf_plugin_api::TypeProvider<#tys> for #ident {
//             fn id<'a>(&self) -> &'a str {
//                 #type_provider_id
//             }
