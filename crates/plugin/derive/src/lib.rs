...
//         quote! {
//             #[reactive_graph_plugin_api::springtime_di::component_alias]
//         }
//     } else {
//         TokenStream2::new()
//     };
...
//     let json = {
//         quote! {
//             match reactive_graph_plugin_api::serde_json::from_str(asset_str) {
//                 Ok(parsed_entry) => {
...
//     let json5 = {
//         quote! {
//             match reactive_graph_plugin_api::json5::from_str(asset_str) {
//                 Ok(parsed_entry) => {
//                     let entry: <#tys as reactive_graph_graph::NamespacedTypeContainer>::Type = parsed_entry;
//                     reactive_graph_graph::NamespacedTypeContainer::push(&entries, entry);
//                 }
...
//     let toml = {
//         quote! {
//             match reactive_graph_plugin_api::toml::from_str(asset_str) {
//                 Ok(parsed_entry) => {
//                     let entry: <#tys as reactive_graph_graph::NamespacedTypeContainer>::Type = parsed_entry;
//                     reactive_graph_graph::NamespacedTypeContainer::push(&entries, entry);
//                 }
...
//         #component_alias
//         impl reactive_graph_plugin_api::TypeProvider<#tys> for #ident {
//             fn id<'a>(&self) -> &'a str {
//                 #type_provider_id
//             }
