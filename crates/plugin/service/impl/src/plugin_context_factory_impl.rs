...
use reactive_graph_plugin_delegates::TypeSystemProviderRegistryDelegate;
...
impl PluginContextFactory for PluginContextFactoryImpl {
    fn construct_plugin_context(&self) {
        ...
        let type_system_provider_registry = TypeSystemProviderRegistryDelegate::new(&self.type_system_provider_registry);
        // Instance System
        ...
        let plugin_context = PluginContextImpl::new(
            ...
            Arc::new(type_system_provider_registry),
