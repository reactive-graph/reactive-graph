...
pub struct WebResourceManagerDelegate {
    web_resource_manager: Arc<dyn inexor_rgf_runtime_web_api::WebResourceManager + Send + Sync>,
}

impl WebResourceManagerDelegate {
    pub fn new(web_resource_manager: Arc<dyn inexor_rgf_runtime_web_api::WebResourceManager + Send + Sync>) -> Self {
        Self { web_resource_manager }
    }
}

#[async_trait]
impl inexor_rgf_plugin_api::WebResourceManager for WebResourceManagerDelegate {
