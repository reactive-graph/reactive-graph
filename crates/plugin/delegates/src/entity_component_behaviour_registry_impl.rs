...
pub struct EntityComponentBehaviourRegistryDelegate {
    entity_component_behaviour_manager: Arc<dyn reactive_graph_behaviour_service_api::EntityComponentBehaviourManager + Send + Sync>,
    entity_component_behaviour_registry: Arc<dyn reactive_graph_behaviour_service_api::EntityComponentBehaviourRegistry + Send + Sync>,
...
#[async_trait]
impl reactive_graph_plugin_api::EntityComponentBehaviourRegistry for EntityComponentBehaviourRegistryDelegate {
