...
macro_rules! relation_behaviour_transitions {
    ($transitions: ident $(, $fn_name:ident, $fn_ident: ident)*) => {
        pub struct $transitions {
            pub reactive_instance: std::sync::Arc<inexor_rgf_core_model::ReactiveRelation>,
        ...
        impl $transitions {
            pub fn new(reactive_instance: std::sync::Arc<inexor_rgf_core_model::ReactiveRelation>, ty: inexor_rgf_core_model::BehaviourTypeId $(, $fn_name: $fn_ident)*) -> Self {
        ...
        impl $crate::BehaviourDisconnect<inexor_rgf_core_model::ReactiveRelation> for $transitions {
        ...
        impl $crate::BehaviourReactiveInstanceContainer<inexor_rgf_core_model::ReactiveRelation> for $transitions {
            fn get_reactive_instance(&self) -> &std::sync::Arc<inexor_rgf_core_model::ReactiveRelation> {
