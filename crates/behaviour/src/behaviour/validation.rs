...
pub trait BehaviourValidator<ID: Clone, T: ReactiveInstance<ID>>: BehaviourPropertyValidator<ID, T> {
...
pub trait BehaviourPropertyValidator<ID: Clone, T: ReactiveInstance<ID>>: BehaviourReactiveInstanceContainer<ID, T> {
