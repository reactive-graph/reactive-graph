...
#[allow(drop_bounds)]
pub trait BehaviourTransitions<ID: Clone, T: ReactiveInstance<ID>>:
    BehaviourReactiveInstanceContainer<ID, T> + BehaviourInit<ID, T> + BehaviourShutdown<ID, T> + BehaviourConnect<ID, T> + BehaviourDisconnect<ID, T> + Drop
{
