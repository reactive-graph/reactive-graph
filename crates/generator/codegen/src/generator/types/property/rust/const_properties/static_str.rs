...
pub fn generate_convert_const_properties_into_static_str(const_properties_ident: &Ident, properties: &Vec<PropertyType>) -> TokenStream {
    ...
    quote! {
        #[doc(newline)]
        impl From<#const_properties_ident> for &'static str {
            #[inline]
            fn from(properties: #const_properties_ident) -> &'static str {
                match properties {
                    #(#token_stream)*
                }
            }
