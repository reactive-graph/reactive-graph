pub static TYPE_SYSTEM_COMPONENTS: std::sync::LazyLock<reactive_graph_graph::Components> =
    std::sync::LazyLock::new(|| reactive_graph_graph::Components::new().component(crate::reactive_graph::command::command::COMMAND_TYPE.clone()));

pub static TYPE_SYSTEM_ENTITY_TYPES: std::sync::LazyLock<reactive_graph_graph::EntityTypes> =
    std::sync::LazyLock::new(|| reactive_graph_graph::EntityTypes::new().entity(crate::reactive_graph::command::num_commands::NUM_COMMANDS_TYPE.clone()));
...
pub static TYPE_SYSTEM_ID: &str = "reactive_graph::command";
