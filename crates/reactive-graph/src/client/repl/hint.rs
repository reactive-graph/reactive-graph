...
use crate::client::repl::chars::CHAR_ENTER;
use crate::client::repl::chars::CHAR_ERROR;
use crate::client::repl::chars::CHAR_SUGGESTION;
use crate::client::repl::longest_common_prefix;
