...
impl RelationType {
    ...
    pub fn new<OT: Into<ComponentOrEntityTypeId>, RT: Into<RelationTypeId>, IT: Into<ComponentOrEntityTypeId>, D: Into<String>, C: Into<ComponentTypeIds>, P: Into<PropertyTypes>, E: Into<Extensions>>(
        outbound_type: OT,
        ty: RT,
        inbound_type: IT,
        description: D,
    ...
    pub fn builder_with_ty<O: Into<ComponentOrEntityTypeId>, T: Into<RelationTypeId>, I: Into<ComponentOrEntityTypeId>>(outbound_type: O, ty: T, inbound_type: I)  -> RelationTypeBuilder<((ComponentOrEntityTypeId, ), (RelationTypeId, ), (ComponentOrEntityTypeId, ), (), (), (), ())> {
...
impl NamespacedTypePropertyTypeContainer<RelationTypeId, RelationTypeAddPropertyError, RelationTypeUpdatePropertyError, RelationTypeRemovePropertyError, RelationTypeMergePropertiesError> for RelationTypes {
    ...
    fn update_property<N: Into<String>, P: Into<PropertyType>>(&self, relation_ty: &RelationTypeId, property_name: N, property_type: P) -> Result<PropertyType, RelationTypeUpdatePropertyError> {
        let Some(relation_type) = self.0.get_mut(relation_ty) else {
    ...
    fn merge_properties<P: Into<PropertyTypes>>(&mut self, relation_ty: &RelationTypeId, properties_to_merge: P) -> Result<(), RelationTypeMergePropertiesError> {
...
impl NamespacedTypeExtensionContainer<RelationTypeId, RelationTypeAddExtensionError, RelationTypeUpdateExtensionError, RelationTypeRemoveExtensionError, RelationTypeMergeExtensionsError> for RelationTypes {
    ...
    fn update_extension<T: Into<ExtensionTypeId>, E: Into<Extension>>(&self, relation_ty: &RelationTypeId, extension_ty: T, extension: E) -> Result<Extension, RelationTypeUpdateExtensionError> {
        let Some(relation_type) = self.0.get_mut(relation_ty) else {
...
impl From<Vec<RelationType>> for RelationTypes {
    fn from(relation_types: Vec<RelationType>) -> Self {
        Self(relation_types.into_iter().map(|relation_type| (relation_type.ty.clone(), relation_type)).collect())
    }
}
...
impl RelationTypeBuilder<((ComponentOrEntityTypeId, ), (RelationTypeId, ), (ComponentOrEntityTypeId, ), (), (), (), ())> {
    pub fn component<C: Into<ComponentTypeId>>(self, component_ty: C) -> RelationTypeBuilder<((ComponentOrEntityTypeId, ), (RelationTypeId, ), (ComponentOrEntityTypeId, ), (), (ComponentTypeIds, ), (), ())> {
...
impl RelationTypeBuilder<((ComponentOrEntityTypeId, ), (RelationTypeId, ), (ComponentOrEntityTypeId, ), (), (ComponentTypeIds, ), (), ())> {
    pub fn component<C: Into<ComponentTypeId>>(self, ty: C) -> RelationTypeBuilder<((ComponentOrEntityTypeId, ), (RelationTypeId, ), (ComponentOrEntityTypeId, ), (), (ComponentTypeIds, ), (), ())> {
...
// Experimental
impl RelationTypeBuilder<((ComponentOrEntityTypeId, ), (RelationTypeId, ), (ComponentOrEntityTypeId, ), (), (ComponentTypeIds, ), (), ())> {
    pub fn property<P: Into<PropertyType>>(self, property: P) -> RelationTypeBuilder<((ComponentOrEntityTypeId, ), (RelationTypeId, ), (ComponentOrEntityTypeId, ), (), (ComponentTypeIds, ), (PropertyTypes, ), ())> {
...
// Experimental
impl RelationTypeBuilder<((ComponentOrEntityTypeId, ), (RelationTypeId, ), (ComponentOrEntityTypeId, ), (), (ComponentTypeIds, ), (PropertyTypes, ), ())> {
    pub fn property<P: Into<PropertyType>>(self, property: P) -> RelationTypeBuilder<((ComponentOrEntityTypeId, ), (RelationTypeId, ), (ComponentOrEntityTypeId, ), (), (ComponentTypeIds, ), (PropertyTypes, ), ())> {
...
mod tests {
    ...
    use crate::{ComponentTypeId, PropertyTypeContainer};
    use crate::ComponentTypeIdContainer;
    use crate::DataType;
  ...
  "extensions": [
    {
      ...
      "extension": "ext_value"
        ...
        let extension = relation_type.get_own_extension(&ExtensionTypeId::new_from_type("ext_namespace", "ext_name")).unwrap();
