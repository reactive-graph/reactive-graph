...
impl NamespacedTypePropertyTypeContainer<EntityTypeId, EntityTypeAddPropertyError, EntityTypeUpdatePropertyError, EntityTypeRemovePropertyError, EntityTypeMergePropertiesError> for EntityTypes {
    ...
    fn update_property<N: Into<String>, P: Into<PropertyType>>(&self, entity_ty: &EntityTypeId, property_name: N, property_type: P) -> Result<PropertyType, EntityTypeUpdatePropertyError> {
        let Some(entity_type) = self.0.get_mut(entity_ty) else {
...
impl NamespacedTypeExtensionContainer<EntityTypeId, EntityTypeAddExtensionError, EntityTypeUpdateExtensionError, EntityTypeRemoveExtensionError, EntityTypeMergeExtensionsError> for EntityTypes {
    ...
    fn update_extension<T: Into<ExtensionTypeId>, E: Into<Extension>>(&self, entity_ty: &EntityTypeId, extension_ty: T, extension: E) -> Result<Extension, EntityTypeUpdateExtensionError> {
        let Some(entity_type) = self.0.get_mut(entity_ty) else {
  ...
  "extensions": [
    {
      ...
      "extension": "ext_value"
        ...
        let extension = entity_type.get_own_extension(&ExtensionTypeId::new_from_type("ext_namespace", "ext_name")).unwrap();
