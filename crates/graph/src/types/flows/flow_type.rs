...
#[serde(tag = "$id", rename = "https://schema.reactive-graph.io/flow-type.schema.json")]
#[schemars(title = "FlowType", deny_unknown_fields, extend("$id" = "https://schema.reactive-graph.io/flow-type.schema.json"))]
pub struct FlowType {
