...
#[serde(tag = "$id", rename = "https://schema.reactive-graph.io/relation-instance.schema.json")]
#[schemars(title = "RelationInstance", rename = "RelationInstance", deny_unknown_fields, extend("$id" = "https://schema.reactive-graph.io/relation-instance.schema.json"))]
