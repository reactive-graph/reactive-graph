...
`reactive_graph::event::SystemEvent`
...
|---------------------------------|---------------------------------------------------------------------------------------------------|-----------------------------------|
| `reactive_graph::event::Event`  | This component spawns events.                                                                     | <ul compact><li>`event`</li></ul> |
...
[https://schema.reactive-graph.io/schema/json/dynamic_graph/types/entity/reactive_graph/event/SystemEvent.schema.json]()

```json
{
  "$id": "https://schema.reactive-graph.io/schema/json/dynamic_graph/types/entity/reactive_graph/event/SystemEvent.schema.json",
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "description": "Events of the type system",
  "properties": {
    "$id": {
      "default": "https://schema.reactive-graph.io/schema/json/dynamic_graph/types/entity/reactive_graph/event/SystemEvent.schema.json",
  ...
  "title": "reactive_graph::event::SystemEvent",
  "type": "object"
}
```
