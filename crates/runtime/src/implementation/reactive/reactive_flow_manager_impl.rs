...
#[provides]
fn create_reactive_flow_instances_storage() -> ReactiveFlowsStorage {
    ReactiveFlowsStorage(RwLock::new(BTreeMap::new()))
}
...
pub struct ReactiveFlowManagerImpl {
    ...
    reactive_flow_instances: ReactiveFlowsStorage,
