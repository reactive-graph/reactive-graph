...
//
// use crate::builder::{EntityTypeBuilder, ReactiveEntityInstanceBuilder, ReactiveRelationInstanceBuilder, RelationTypeBuilder};
...
//
// #[test]
// fn test_reactive_relation_instance_manager() {
...
//     let reactive_relation_instance_manager = application.get_reactive_relation_instance_manager();
//
...
//
//     let result = ReactiveEntityInstanceBuilder::new(outbound_type.clone())
//         .id(outbound_id)
//         .property(property_name.clone(), property_value.clone())
//         .create(reactive_entity_instance_manager.clone());
//     assert!(result.is_ok());
//     assert!(reactive_entity_instance_manager.has(outbound_id));
//
//     let result = ReactiveEntityInstanceBuilder::new(inbound_type.clone())
//         .id(inbound_id)
//         .property(property_name.clone(), property_value.clone())
//         .create(reactive_entity_instance_manager.clone());
//     assert!(result.is_ok());
//     assert!(reactive_entity_instance_manager.has(inbound_id));
//
//     assert!(!reactive_relation_instance_manager.has(edge_key.clone()));
//     assert!(reactive_relation_instance_manager.get(edge_key.clone()).is_none());
//     let result = ReactiveRelationInstanceBuilder::new(outbound_id, type_name.clone(), inbound_id)
//         .property(property_name.clone(), property_value.clone())
//         .create(reactive_relation_instance_manager.clone());
//     assert!(result.is_ok());
//     assert!(reactive_relation_instance_manager.has(edge_key.clone()));
//     assert!(reactive_relation_instance_manager.get(edge_key.clone()).is_some());
//
...
//     reactive_relation_instance_manager.commit(edge_key.clone());
//
...
//
//     reactive_relation_instance_manager.delete(edge_key.clone());
//     assert!(!reactive_relation_instance_manager.has(edge_key.clone()));
//     assert!(reactive_relation_instance_manager.get(edge_key.clone()).is_none());
...
//
// #[test]
// fn test_reactive_relation_instance_manager_import_export() {
//     let application = init_application();
//     let entity_type_manager = application.get_entity_type_manager();
//     let reactive_entity_instance_manager = application.get_reactive_entity_instance_manager();
//     let relation_type_manager = application.get_relation_type_manager();
...
//
//     reactive_relation_instance_manager.export(edge_key.clone(), path.clone());
//     assert!(reactive_relation_instance_manager.has(edge_key.clone()));
//     assert!(relation_instance_manager.has(edge_key.clone()));
//
...
//     assert!(!relation_instance_manager.has(edge_key.clone()));
//
//     let result = reactive_relation_instance_manager.import(path.clone());
//     assert!(result.is_ok());
//     let reactive_relation_instance = result.unwrap();
//     assert_eq!(outbound_id, reactive_relation_instance.outbound.id);
//     assert_eq!(type_name.clone(), reactive_relation_instance.type_name.clone());
