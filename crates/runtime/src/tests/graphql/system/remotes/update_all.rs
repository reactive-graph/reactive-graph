...
const MUTATION_UPDATE_ALL_REMOTES: &str = include_str!("../../../../../graphql/system/remotes/update_all.graphql");

async fn mutation_update_all_remotes(query_service: &Arc<dyn GraphQLQueryService>) -> Vec<InstanceInfo> {
    ...
    data.system.remotes.update_all
}
