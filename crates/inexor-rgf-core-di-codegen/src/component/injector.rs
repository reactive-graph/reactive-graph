...
impl Injector for WrcInjector {
    fn generate_inject_code(
        ...
        let referenced_type_opt = if to_inject
            .type_name
            .starts_with("inexor_rgf_core_di :: Wrc <")
...
impl Injector for DeferredInjector {
    fn generate_inject_code(
        ...
        let referenced_type_opt = if to_inject
            .type_name
            .starts_with("inexor_rgf_core_di :: Deferred <")
        {
...
impl Injector for PropInjector {
    fn generate_inject_code(
        ...
        let (prop_name_opt, default_value_code) = if to_inject.prop_attr.is_some() {
            ...
            let prop_name_opt = prop_attr.name.clone().or(to_inject
                .arg_name
                .clone()
