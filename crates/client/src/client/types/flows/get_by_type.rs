...
pub mod queries {
    ...
    use crate::types::flows::type_id::queries::FlowTypeIdVariables;
    use crate::types::flows::type_id::queries::FlowTypeIdVariablesFields;

    #[derive(QueryFragment, Debug)]
    #[cynic(graphql_type = "Query", variables = "FlowTypeIdVariables")]
    pub struct GetFlowTypeByType {
        pub types: GetFlowTypeByTypeTypes,
    }

    #[derive(QueryFragment, Debug)]
    #[cynic(graphql_type = "Types", variables = "FlowTypeIdVariables")]
    ...
    pub fn get_flow_type_by_type_query(ty: &FlowTypeId) -> Operation<GetFlowTypeByType, FlowTypeIdVariables> {
