...
fn reactive_flow_test() {
    ...
    let reactive_flow_instance = ReactiveFlow::new(wrapper_entity_instance.clone());
    ...
    let reactive_flow_instance_2 = ReactiveFlow::from(wrapper_entity_instance.clone());
...
fn reactive_flow_test_try_into() {
    ...
    let reactive_flow_instance_copy = ReactiveFlow::try_from(flow_instance).unwrap();
...
fn reactive_flow_test_try_fail() {
    let wrapper_entity_instance = Arc::new(create_random_entity_instance_with_type("namespace", "generic_flow", "test"));
    let mut reactive_flow_instance = ReactiveFlow::new(wrapper_entity_instance.clone());
...
fn reactive_flow_test_try_fail_2() {
    let wrapper_entity_instance = Arc::new(create_random_entity_instance_with_type("namespace", "generic_flow", "test"));
    let reactive_flow_instance = Arc::new(ReactiveFlow::new(wrapper_entity_instance.clone()));
